...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=flat&logo=vercel&logoColor=white)](https://gorkemuysal.com)
...
`React` `React Native` `JavaScript (ES6+)` `TypeScript` `Redux / Context API` `Chakra UI` `Bootstrap`
`Java` `Spring Boot` `Spring Data JPA` `Spring Security` `PostgreSQL` `SQL`
...
| Şirket | Rol | Dönem |
|---|---|---|
| Safespeech Yazılım Bilişim Danışmanlık A.Ş. | Yazılım Stajyeri | Haz 2026 – Ağu 2026 |
| İnvivo Yazılım ve Teknoloji A.Ş. | Remote Front-End Developer | Tem 2023 – Eki 2024 |

### 🚀 Spring Boot Öğrenme Yolculuğu

Katmanlı mimariden başlayıp güvenlik, migration, concurrency ve production'a yakın pratiklere doğru ilerleyen 5 projelik bir seri:
...
- **Akıllı Telefon Tabanlı Belediye Sorun Bildirim Sistemi** — TÜBİTAK 2209-A Projesi. Yerel yönetimlerde sorun bildirim süreçlerini dijitalleştiren, React Native + Node.js tabanlı Ar-Ge projesi.
- **Gym Log – Spor Günlüğü** — React Native ile geliştirilmiş, App Store & Google Play'de yayında olan spor takip uygulaması. [App Store](https://apps.apple.com/us/app/gymlogsporgunlugu/id6757125327) · [Google Play](https://play.google.com/store/apps/details?id=com.gorkemuysal.gymlogsporgunlugu)
- **Ne Anlatıyorsun** — React Native altyapılı, AI destekli görsel üretimi kullanan kelime/oyun projesi. [Google Play](https://play.google.com/store/apps/details?id=com.oriviolabs.neanlatiyorsunn)
...
| Company | Role | Period |
|---|---|---|
| Safespeech Software & IT Consulting Inc. | Software Intern | Jun 2026 – Aug 2026 |
| İnvivo Software & Technology Inc. | Remote Front-End Developer | Jul 2023 – Oct 2024 |

### 🚀 Spring Boot Learning Journey

A five-project series progressing from basic layered architecture to security, migrations, concurrency, and near-production practices:

| # | Project | Focus | Key Tech | Repo |
|---|---|---|---|---|
| 1 | Student App | Layered architecture basics, REST CRUD | Spring Web MVC | [↗](https://github.com/grkmuysl/spring-boot-student-crud-api) |
...
- **Smartphone-Based Municipal Issue Reporting System** — TÜBİTAK 2209-A funded R&D project digitizing issue-reporting workflows for local governments, built with React Native + Node.js.
- **Gym Log** — Cross-platform fitness tracking app built with React Native, live on the App Store & Google Play. [App Store](https://apps.apple.com/us/app/gymlogsporgunlugu/id6757125327) · [Google Play](https://play.google.com/store/apps/details?id=com.gorkemuysal.gymlogsporgunlugu)
- **Ne Anlatıyorsun** — A creative word/party game built with React Native, using AI-generated visual assets, live on Google Play. [Google Play](https://play.google.com/store/apps/details?id=com.oriviolabs.neanlatiyorsunn)

---

<div align="center">

📫 **gorkmuysal@gmail.com** · 🌐 **gorkemuysal.com**
